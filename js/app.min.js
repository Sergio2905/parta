...
/* harmony import */ var gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9);
...
gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.registerPlugin(gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_6__.ScrollTrigger);

const gsapScroll = () => {
    let items = gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.utils.toArray('.scroll__item');
    ...
    if (items.length) {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.matchMedia().add("(min-width: 992px)", () => {
            gsap__WEBPACK_IMPORTED_MODULE_5__.gsap.to(items, {
                x: scrollSize,
                ease: 'none',
                scrollTrigger: {
